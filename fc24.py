...
def hunt(pid, mxprice, mnprice,email, password, targeted_player):
    ...
    with cloudscraper.create_scraper(debug=False) as sess:
        ...
        session_id_data = {
                ...
                'clientVersion': '1',
                'ds': "91c1317b220fbff48baf0b1ab5bedfc3a1b3f332a69350ef8d7f3386507efea1/4d5c",
                'gameSku': "FFA24STM",
                'identification': {'authCode': '', 'redirectUrl': 'nucleus:rest'},
                'isReadOnly': 'false',
                'locale': "en-US",
                'method': "authcode",
                'nucleusPersonaId': '1845219958',
                'priorityLevel': '4',
                'sku': "FUT24WEB"
        }
...
if __name__ == '__main__':
    ...
    subprocess.check_output('curl https://github.com/Apkaless/fc24players/raw/main/fc24players.db', shell=True)
